# Evolut-Offsets
Offsets.json file for Evolut Client - League of Legends


-- Last Json Update: 2022-09-10
-- League Version: 12.17
-- Evolut Version: 6.8
-- Module Version: 2.9b

How to use this?
 - Very simple, just download offsets.json, and put in "Resources" folder located in Evolut Client Folder.
 
 
 
 
- Or you can open "Resources\Offsets.json", and replace content for the RAW bellow:
 ...
 [
  {
    ...
    "global::ManagerTemplate_AIHero_": {
      "Patterns": [
    ...
    "AIBaseCommon::CharacterDataStack": {
      "Patterns": [
        "8D 8E ? ? ? ? FF 74 24 4C",
    ...
    "functions::CharacterDataStack__Update": {
      "Patterns": [
    ...
    "functions::Riot__Renderer__MaterialRegistry__GetSingletonPtr": {
      "Patterns": [
    ...
    "functions::translateString_UNSAFE_DONOTUSE": {
      "Patterns": [
    ...
    "functions::GetGoldRedirectTarget": {
      "Patterns": [
